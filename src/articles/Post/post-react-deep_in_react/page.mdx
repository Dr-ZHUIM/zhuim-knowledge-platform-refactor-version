...
<Image src="/article_img/React/react-hook-timeline-diagram.png" />
...
<Image src="/article_img/React/react-hook-lifecycle.png" />
...
在 React 18 版本，React 添加了 并发渲染 (concurrent render) 的一些 API，比如说 <Link className="inline" target="_blank" href="https://react.dev/reference/react/useTransition#usetransition" children="useTransition"></Link>
...
在官方文章<Link target="_blank" href="hhttps://react.dev/reference/react/memo#skipping-re-rendering-when-props-are-unchanged" children='the new React docs specifically address the "memo everything?" question'></Link>如是提到：
